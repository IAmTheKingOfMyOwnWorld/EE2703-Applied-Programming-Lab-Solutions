...
pylab.figure(5)
pylab.semilogy(range(Niter)[::50],errors[::50],'ro',label='errors')                     # Making A Plot With Log Scaling On The y-axis
pylab.semilogy(range(Niter)[::50],fit(range(Niter)[::50],A,B),'go',label='fit1')        # Making A Plot With Log Scaling On The y-axis
pylab.semilogy(range(Niter)[::50],fit(range(Niter)[::50],A500,B500),'bo',label='fit2')  # Making A Plot With Log Scaling On The y-axis
