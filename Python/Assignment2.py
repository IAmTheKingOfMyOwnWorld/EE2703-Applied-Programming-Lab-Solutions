...
try:
    ...
    # Printing Current Through Inductor If Independent Voltage Sources Produce DC
    if DC:
        for k in range(len(inductorDictionary)):
            print("The current through inductor {} is {}".format(Key(inductorDictionary, k), x[N+VS+k]))
