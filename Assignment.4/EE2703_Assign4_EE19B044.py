...
xActual=np.linspace(-2*np.pi,4*np.pi,30)        # Constructing An Array Of Evenly Spaced Numbers Over A Specified Interval
xExpected=np.linspace(0,2*np.pi,10)             # Constructing An Array Of Evenly Spaced Numbers Over A Specified Interval
